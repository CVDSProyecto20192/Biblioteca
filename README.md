...
- Scrum Master-Team: Andrés Ricardo Martínez Días
...
También tendrá la posibilidad de observar un resumen de las estadisticas en un gráfico de barras, presionando sobre un link:
![](Imagenes/ReporteGrafico.PNG)
